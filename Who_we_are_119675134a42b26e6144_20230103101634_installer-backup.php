...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'Who_we_are_119675134a42b26e6144_20230103101634_archive.zip';
        const ARCHIVE_SIZE       = '28588213';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '1196751-03101634';
        const SECONDARY_PACKAGE_HASH = 'af3b7eb-03101634';
        const VERSION            = '1.5.1';
